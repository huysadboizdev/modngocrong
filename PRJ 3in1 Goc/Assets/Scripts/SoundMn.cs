...
public class SoundMn
{
	...
	public void getStrOption()
	{
		if (GameCanvas.isLoadRes)
		{
			...
			{
				(Char.isPaintAura ? (text + mResources.aura_on.Trim()) : (text2 + mResources.aura_off.Trim())),
				(Char.isPaintAura2 ? (text + mResources.aura_on_2.Trim()) : (text2 + mResources.aura_off_2.Trim())),
	...
	{
		Char.isPaintAura = !Char.isPaintAura;
		Rms.saveRMSInt("isPaintAura", Char.isPaintAura ? 1 : 0);
		getStrOption();
	}

	public void AuraToolOption2()
	{
		Char.isPaintAura2 = !Char.isPaintAura2;
		Rms.saveRMSInt("isPaintAura2", Char.isPaintAura2 ? 1 : 0);
		getStrOption();
	}
